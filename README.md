...
`sleep-routine-coach` 想做的事情很小：在该收尾的时候轻轻提醒你，在你说“晚安”之后保持安静，在你说“早安”时顺手记下昨晚的情况。它不会因为一天做得不理想而责备你，也不会用连续打卡把睡觉变成另一项绩效任务。

**主动，但克制。** 你只需要自然地说“晚安”和“早安”；数据默认留在本地；提醒时间、允许时段和发送渠道都由你决定。它不是医疗诊断工具，也不声称治疗或治愈失眠。
...
- **睡前不轰炸。** 临近睡眠窗口时最多轻轻提醒一次；没有回应就不继续催。
- **一句晚安就够了。** 记录的是“准备睡觉时间”，不是假装知道你真正几点睡着。说完晚安后，它会进入夜间静默。
- **早上只问必要的。** 一句早安完成醒来记录，再问最多两个很短的问题，不把刚醒来的你拉进一张长表格。
...
它更关心的是：你的作息是否正在慢慢变得稳定？什么时间的提醒真正有用？哪些提醒经常被忽略，应该减少或关闭？每周摘要只描述已经记录到的趋势，不给你打分，也不把相关性说成原因。
